...
use nomad_base::{decl_settings, AgentSecrets, AgentSettingsBlock, NomadAgent};

// Example settings block containing addition agent-specific fields
#[derive(Debug, Clone, serde::Deserialize)]
pub struct ExampleAgentSettingsBlock;

// Show how to derive agent-specific settings block from config and secrets
impl AgentSettingsBlock for ExampleAgentSettingsBlock {
    fn from_config_and_secrets(
        _home_network: &str,
        _config: &nomad_xyz_configuration::NomadConfig,
...
decl_settings!(Example, ExampleAgentSettingsBlock,);
